...
input double              RSI_Overbought = 62;        // RSI Overbought Level
input double              RSI_Oversold = 32;          // RSI Oversold Level
input double              RSI_Target_Buy = 67;         // RSI Target for Buy Exit
input double              RSI_Target_Sell = 2;        // RSI Target for Sell Exit
...
input double TrailingStopDistancePoints = 50.0;   // SL distance from bid/ask (points)
input double TrailingActivationPoints = 39.0;         // min profit before trailing (0 = same as distance)
